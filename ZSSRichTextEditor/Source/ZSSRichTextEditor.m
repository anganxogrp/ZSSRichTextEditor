...
- (void)viewDidLoad {
    ...
    if (![self isIpad]) {
        ...
        self.keyboardItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSkeyboard" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(dismissKeyboard)];
    ...
    if (!self.resourcesLoaded) {
        NSString *filePath = [[NSBundle mainBundle] pathForResource:@"editor" ofType:@"html" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"];
        NSData *htmlData = [NSData dataWithContentsOfFile:filePath];
        NSString *htmlString = [[NSString alloc] initWithData:htmlData encoding:NSUTF8StringEncoding];
        NSString *source = [[NSBundle mainBundle] pathForResource:@"ZSSRichTextEditor" ofType:@"js" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"];
...
- (NSArray *)itemsForToolbar {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarBold]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *bold = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSbold" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setBold)];
        bold.label = @"bold";
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarItalic]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *italic = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSitalic" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setItalic)];
        italic.label = @"italic";
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarSubscript]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *subscript = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSsubscript" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setSubscript)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarSuperscript]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *superscript = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSsuperscript" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setSuperscript)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarStrikeThrough]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *strikeThrough = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSstrikethrough" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setStrikethrough)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUnderline]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *underline = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSunderline" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setUnderline)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRemoveFormat]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *removeFormat = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSclearstyle" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(removeFormat)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUndo]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *undoButton = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSundo" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(undo:)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRedo]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *redoButton = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSredo" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(redo:)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyLeft]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignLeft = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSleftjustify" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignLeft)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyCenter]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignCenter = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSScenterjustify" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignCenter)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyRight]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignRight = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSrightjustify" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignRight)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyFull]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignFull = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSforcejustify" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignFull)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarParagraph]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *paragraph = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSparagraph" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(paragraph)];
        paragraph.label = @"p";
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH1]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h1 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh1" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading1)];
        h1.label = @"h1";
        [items addObject:h1];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH2]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h2 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh2" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading2)];
        h2.label = @"h2";
        [items addObject:h2];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH3]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h3 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh3" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading3)];
        h3.label = @"h3";
        [items addObject:h3];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH4]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h4 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh4" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading4)];
        h4.label = @"h4";
        [items addObject:h4];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH5]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h5 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh5" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading5)];
        h5.label = @"h5";
        [items addObject:h5];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH6]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h6 = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSh6" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading6)];
        h6.label = @"h6";
        [items addObject:h6];
    }
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarTextColor]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *textColor = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSStextcolor" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(textColor)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarBackgroundColor]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *bgColor = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSbgcolor" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(bgColor)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUnorderedList]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *ul = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSunorderedlist" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setUnorderedList)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarOrderedList]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *ol = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSorderedlist" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setOrderedList)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarHorizontalRule]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *hr = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSShorizontalrule" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setHR)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarIndent]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *indent = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSindent" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setIndent)];
        indent.label = @"indent";
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarOutdent]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *outdent = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSoutdent" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(setOutdent)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarInsertImage]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *insertImage = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSimage" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(insertImage)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarInsertLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *insertLink = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSlink" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(insertLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRemoveLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *removeLink = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSunlink" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework"]] style:UIBarButtonItemStylePlain target:self action:@selector(removeLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarQuickLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *quickLink = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSquicklink" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(quickLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarViewSource]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *showSource = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:[[NSBundle mainBundle] pathForResource:@"ZSSviewsource" ofType:@"png" inDirectory:@"Frameworks/ZSSRichTextEditor.framework/"]] style:UIBarButtonItemStylePlain target:self action:@selector(showHTMLSource:)];
